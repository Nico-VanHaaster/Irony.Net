...
namespace Irony.Samples.SQL
{
    ...
    public class SqlGrammar : Grammar
    {
        ...
        { //SQL is case insensitive
            ...
            //var p_id = new IdentifierTerminal("param", "", "@");
            //var p_term = new NonTerminal("Parameter");
            ...
            expression.Rule = term | unExpr | binExpr | p_term;// | betweenExpr; //-- BETWEEN doesn't work - yet; brings a few parsing conflicts 
            term.Rule =  Id | string_literal | number | funCall | tuple | parSelectStmt;// | param_id;// | inStmt;
            tuple.Rule = "(" + exprList + ")";
