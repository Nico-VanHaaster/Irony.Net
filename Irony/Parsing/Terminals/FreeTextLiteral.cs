...
namespace Irony.Parsing
{
    ...
    public class FreeTextLiteral : Terminal
    {
        ...
        private Token TryMatchContentSimple(ParsingContext context, ISourceStream source)
        {
            ...
            StringComparison stringComp = StringComparison.CurrentCulture;
#if _PCL_
            stringComp = Grammar.CaseSensitive ? StringComparison.CurrentCulture : StringComparison.CurrentCultureIgnoreCase;
#else
            stringComp = Grammar.CaseSensitive ? StringComparison.InvariantCulture : StringComparison.InvariantCultureIgnoreCase;
#endif
