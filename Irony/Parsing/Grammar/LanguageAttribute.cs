...
namespace Irony.Parsing
{
    ...
    public class LanguageAttribute : Attribute
    {
        ...
        public static LanguageAttribute GetValue(Type grammarClass)
        {
            object[] attrs = null;
#if _PCL_
            attrs = grammarClass.GetTypeInfo().GetCustomAttributes(typeof(LanguageAttribute), true).ToArray();
#else
            attrs = grammarClass.GetCustomAttributes(typeof(LanguageAttribute), true);
#endif
